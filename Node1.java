...
public class Node1 extends UnicastRemoteObject implements Node {
    private int nodeId;
    ...
    public Node1(int nodeId, int numNodes, Edge[] edges) throws RemoteException {
        this.nodeId = nodeId;
    ...
    public static void main(String[] args) {
        try {
            ...
            Node1 node = new Node1(0, numNodes, edges);
            Naming.rebind("rmi://localhost/Node1", node);
