...
public class Node2 extends UnicastRemoteObject implements Node {
    private int nodeId;
    ...
    public Node2(int nodeId, int numNodes, Edge[] edges) throws RemoteException {
        this.nodeId = nodeId;
    ...
    public static void main(String[] args) {
        try {
            ...
            Node2 node = new Node2(0, numNodes, edges);
            Naming.rebind("rmi://localhost/Node2", node);
