...
public class Node3 extends UnicastRemoteObject implements Node {
    private int nodeId;
    ...
    public Node3(int nodeId, int numNodes, Edge[] edges) throws RemoteException {
        this.nodeId = nodeId;
    ...
    public static void main(String[] args) {
        try {
            ...
            Node3 node = new Node3(0, numNodes, edges);
            Naming.rebind("rmi://localhost/Node3", node);
